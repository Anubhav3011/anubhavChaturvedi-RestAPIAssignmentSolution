...
public class SwaggerConfig {
	...
	public Docket employeeApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo("EmployeeManagement"))
				.groupName("EmployeeManagement-API").select()
				.apis(RequestHandlerSelectors.basePackage("com.management.controller")).build();
	}
